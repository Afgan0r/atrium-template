Версия темплейта - 1.1.6
Рефакторинг темплейта и readme - Afgan0r
...
!!!!!!!!!
Учитывайте, что в этом варианте шаблона Атриума в выдаче снаряжения должно использоваться _this вместо _unit. Мод ниже экспортирует корректно и ничего менять не нужно.
...
2) Настроить скрипт в файле "Scripts\CapturePoint\initCapturePoint.sqf". Более подробно про работу скрипта можно почитать в файле "Scripts\CapturePoint\readme.txt";

Как добавить снаряжение в пехотный юнит:
Прописать в юнит - [this, "BLUFOR", "TL"] call unitGearProcessor;
, где BLUFOR - название папки в Equipment, TL - название файла в папке BLUFOR.

Как добавить снаряжение в технику:
Прописать в технику - [this, "BLUFOR_veh", "mrap"] call vehicleCargoProcessor;
, где BLUFOR_veh - название папки в Equipment, mrap - название файла в папке BLUFOR_veh.
...
, где bluforPlane - индивидуальный класс, который вы придумываете для одного типа техники (условно наземка красных opforGround, наземка синих blueforGround и т.д.).

Как добавить свои вкладки в брифинг:
В файле "Scripts\customBriefing.sqf" добавить в соответствующие места вызов команды player createDiaryRecord ["diary", ["Заголовок", loadFile "A3A_BRIEFING\briefing_FILENAME.html"]];
, где "Заголовок" - название вкладки в брифинге, "A3A_BRIEFING\briefing_FILENAME.html" - путь до файла
